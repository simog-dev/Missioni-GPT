...
with st.sidebar:
    ...
    st.write("⚡ To get detailed answer, ask specific question")
    st.write("📚 The information used to generate responses is extracted from the following document https://github.com/simog-dev/Missioni-GPT/tree/main/data")
    st.markdown("""---""")
